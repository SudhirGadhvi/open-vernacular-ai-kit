...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("address proof clear nahin tha isliye reject hua", "address proof clear नहीं था इसलिए reject हुआ"),
        ("mujhe jaldi refund chahiye", "मुझे जल्दी refund चाहिए"),
        ("discount apply nhi hua aj bhi", "discount apply नहीं हुआ आज भी"),
        ("otp aj tk nahi aaya yrr", "otp आज तक नहीं आया yrr"),
        ("office me hu baad me call krna", "office में hu बाद में call करना"),
        ("coupon code bilkul work nhi kr rha", "coupon code बिल्कुल work नहीं कर रहा"),
        ("verify ke liye photo dubara upload kr do", "verify के लिए photo दुबारा upload कर दो"),
        ("pickup subah hoga ya dopahar baad?", "pickup सुबह होगा या दोपहर बाद?"),
        ("mere account se same amount do baar debit hua", "मेरे account से same amount दो बार debit हुआ"),
        ("mere order me ek item kam aaya hai aur invoice me bhi do hi item dikh rahe hain", "मेरे order में एक item कम आया है और invoice में भी दो ही item दिख रहे हैं"),
